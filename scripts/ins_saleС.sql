...
select @ProdID=p.ProdID, @UM=p.UM, @Barcode=mq.Barcode
    from r_Prods p, r_ProdMQ mq where mq.ProdID=p.ProdID and p.Article2 = @Article2
...
INSERT INTO t_SaleC( ChID, SrcPosID, ProdID, UM, Qty, PriceCC_nt, SumCC_nt, Tax, TaxSum, PriceCC_wt, SumCC_wt,
  BarCode, CReasonID, EmpID, CreateTime, ModifyTime)
VALUES( @ChID, @SrcPosID, @ProdID, @UM, @Qty, @PriceCC_nt, @SumCC_nt, @Tax, @TaxSum, @PriceCC_wt, @SumCC_wt,
  @BarCode, 0, @EmpID, @CreateTime, @ModifyTime)